...
(module || {}).exports = renderjson = (function () {
    ...
    function _renderjson(json, indent, dont_indent, show_level, max_string, sort_objects, result_name) {
        ...
        var disclosure = function (open, placeholder, close, type, builder) {
            ...
            var el = append(span(), text(dont_indent ? my_indent : result_name), empty);
            if (show_level > 0)
                show();
            return el;
        };
        ...
        if (typeof (json) != "object") // Strings, numbers and bools
            return themetext(null, my_indent, typeof (json), utf8Decode(JSON.stringify(json, stringifyReplacer)));
    ...
    var renderjson = function renderjson(json, result_name) {
        var pre = append(document.createElement("pre"), _renderjson(json, "", false, renderjson.show_to_level, renderjson.max_string_length, renderjson.sort_objects, result_name));
